...
class CBFVerificationStrategy:
    ...
    def __init__(self, network_path, dynamics_model, use_gpu=True):
        self.network_path = network_path
        self.dynamics_model = dynamics_model
        self.use_gpu = use_gpu

    @staticmethod
    def _handle_split(sample, start_time, results, sample_idx, min_volume, split_type, unsat_type):
        """Record a MAYBE result via splitting or an UNSAT counterexample if splitting is not possible."""
