...
class WrappedBPOperation(nn.Module):
    ...
    def __add__(self, other):
        if isinstance(other, WrappedBPOperation):
            ...
            return WrappedBPOperation(bp.Add(self.op, Constant(other)))
    ...
    def __sub__(self, other):
        if isinstance(other, WrappedBPOperation):
            ...
            return WrappedBPOperation(bp.Sub(self.op, Constant(other)))
    ...
    def __rsub__(self, other):
        if isinstance(other, WrappedBPOperation):
            ...
            return WrappedBPOperation(bp.Sub(Constant(other), self.op))
...
class WrappedBPVector(WrappedBPOperation):
    ...
    def __getitem__(self, item):
        ...
        return WrappedBPOperation(bp.Select(item))
