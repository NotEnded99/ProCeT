...
from ..dynamics import LorenzAttractor, NNDynamics
from ..train_nn import load_torch_model
...
if __name__ == "__main__":
    ...
    large_network = load_torch_model(
        "data/compression_ground_truth.pth",
    ...
    compressed_network = load_torch_model(
        "data/compression_compressed.pth",
        input_size=true_dynamics.input_dim,
